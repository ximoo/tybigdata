    ...
    <div class="ex-pages-content" :class="{'hide-menu':hideMenu}">
      ...
      <div class="ex-table-content">
        ...
        <div class="ex-table-query">
          <el-form :inline="true" :model="queryData" size="mini">
            ...
            <el-form-item label="园区名称">
              <el-input v-model="queryData.title" placeholder="请输入您要查询的园区名称"></el-input>
            </el-form-item>
        ...
        >
          ...
          <el-table-column prop="mileage" label="园区范围" width="120" align="center">
            <template slot-scope="scope">
              <el-button
                size="mini"
                plain
          ...
          <el-table-column prop="mileage" label="地磅" width="120" align="center">
            <template slot-scope="scope">
              <el-button
                size="mini"
                plain
...
export default {
  ...
  computed: {
    tableTotal() {
      console.log(this.$store.state.simData.landfill.length);
      return this.$store.state.simData.landfill.length;
    },
    landfillInfo() {
      let simData = this.$store.state.simData;
      let siteData = this.$store.state.platformData.module.sitemonitor.module
        .fences.landfill;
      simData.landfill = siteData;
      localStorage.$simData = JSON.stringify(simData);
      return simData.landfill.slice(0, 20);
    }
  }
};
</script>
