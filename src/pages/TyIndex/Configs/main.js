...
VueAMap.initAMapApiLoader({
  ...
  plugin: ['Map3D', 'AMap.DistrictSearch', 'AMap.SimpleMarker', 'AMap.DistrictLayer', 'AMap.ControlBar','AMap.MouseTool',"AMap.PolyEditor","AMap.MarkerClusterer","AMap.InfoWindow","AMap.Heatmap", "AMap.Driving", "AMap.TruckDriving"],
  v: '1.4.15'
});
